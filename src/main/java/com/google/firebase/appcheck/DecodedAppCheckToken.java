...
/**
 * A decoded and verified Firebase App Check token. Can be used to get the app_id and other
 * attributes available in the token. See {@link FirebaseAppCheck#verifyToken(String)}
